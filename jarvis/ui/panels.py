...
class SettingsPanel(QWidget):
    ...
    def __init__(self, app, parent: QWidget | None = None) -> None:
        ...
        self.tts_engine.addItems(["auto", "fish", "edge", "cartesia",
                                  "elevenlabs", "pyttsx3"])
        ...
        voice.addRow("Edge voice name", self.edge_voice)
        self.fish_voice = QLineEdit(self.app.settings.get("voice.fish_voice_id", ""))
        self.fish_voice.setPlaceholderText("voice model id from fish.audio")
        voice.addRow("Fish Audio voice id", self.fish_voice)
    ...
    def _save(self) -> None:
        ...
        settings.set("voice.fish_voice_id", self.fish_voice.text().strip())
